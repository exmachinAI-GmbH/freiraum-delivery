...
| Verbindung | Wirt: psql-freiraum-pilot.postgres.database.azure.com · Port: 5432 · Datenbank: freiraum · Konto: frxadmin · sslmode: require |
| War es die Zielumgebung? | **Ja** — psql-freiraum-pilot.postgres.database.azure.com, Datenbank `freiraum`, Sweden Central · eingetragen 22.08.2026 · M. Veil, A. Han |
| Prüfsummen der Eingänge nachgerechnet | ja |
| Belegordner | `/Users/mveil/freiraum-delivery/migrations/../nachweise/kettenlauf/260822_2129_alle` |
