...
--
-- Name: create_app_after_fit(uuid, text, text, uuid, uuid); Type: FUNCTION; Schema: public; Owner: freiraum
--
...
ALTER FUNCTION public.create_app_after_fit(p_tenant uuid, p_project_no text, p_name text, p_fit_check uuid, p_actor uuid) OWNER TO freiraum;

--
-- Name: FUNCTION create_app_after_fit(p_tenant uuid, p_project_no text, p_name text, p_fit_check uuid, p_actor uuid); Type: COMMENT; Schema: public; Owner: freiraum
--
...
--
-- Name: FUNCTION create_app_after_fit(p_tenant uuid, p_project_no text, p_name text, p_fit_check uuid, p_actor uuid); Type: ACL; Schema: public; Owner: freiraum
--
